...
$sql = "INSERT INTO `healthdata` (`BMR`, `total_calories`,`id`)
                          VALUES ('$bmr','$lose1','$id')";
$result = mysqli_query($conn, $sql);
if($result){ 
  echo "<script>alert('Great! User calories added.')</script>";
...
$sql =$sql = " UPDATE `user` SET `gender`='$gender', `age`='$age', `c_weight`='$c_weight', `g_weight`='$g_weight', `height`='$height', `a_level`='$a_level', `goal`='$goal'
             WHERE id='$id'";
$result = mysqli_query($conn, $sql);
$sql = "INSERT INTO `healthdata` (`BMR`, `total_calories`, `id`)
                          VALUES ('$bmr' , '$lose1' , '$id')";
...
<body class="health">
  <div class="welcome-text">
    <?php echo "<h1> Welcome " . $_SESSION['username'] . " please answer the following questions to help us make your plan</h1>"; ?> </div>
    ...
    <div class="health-form">
      <div class="container">
        <div class="above">
          ...
          <br>
          <br> Age:
          <input class="age" style="" ; name="age" type="text" placeholder="years" value="<?php echo $age; ?>">
          <br>
          <br> Current Weight:
          ...
          <br>
          <br> Height:
          <input class="height" style="" name="height" type="text" placeholder="cm" value="<?php echo $height; ?>">
          <br>
          <br>
        </div>
        Your activity level:
        ...
        <a href="termsandconditions.html">terms and conditions</a> as set out by the user agreement.</input>
        <div class="groupbtnn">
          <br>
          <button name="submit" class="btnn calc">Calculate</button>
        </div>
      </div>
  </form>
</body>
