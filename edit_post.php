...
if(isset($_GET['edit']) && isset($_POST['update'])){
    ...
    $body = $_POST['body'];
    $post_id=$_GET['edit'];
    $sql = "UPDATE `posts` SET `body`='$body', `title`='$title', `id`='$id'
...
?>
    ...
    margin: auto;" class="card">
            ...
            <form style="margin-top: 51px; margin-left: 300px;" action="" method="post">
                ...
                <div class="input-group">
                    ...
                    <textarea id="mytextarea" name="body" class="form-control" aria-label="With textarea" Required><?php echo $_GET['post']?></textarea>
                </div>
                <button style="width:250px;margin-top:50px;margin-bottom: 150px;" name="update" class="btnn">Share my post</button>
            </form>
    </body>
